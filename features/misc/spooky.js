...
////////////////////////////////////////////////////////////////////////////////
registerWhen('chat', (spookyMob, event) => {
    cancel(event);
...
////////////////////////////////////////////////////////////////////////////////
registerWhen('chat', (spawner, location, event) => {
    cancel(event);
    ...
    spookyAudio.playDefaultSound();
}, () => Settings.horseman_ping && getInHub() && getInSkyblock() && World.isLoaded()).setCriteria("${spawner} has spawned the Headless Horseman boss in the ${location}!");
